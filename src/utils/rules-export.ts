...
export const EXAMPLE_RULES: CustomRule[] = [
  ...
  },
  {
    ...
    caseSensitive: false,
    enabled: true,
    description: 'Phonetic misspelling: fone → phone',
  ...
  },
  {
    ...
    caseSensitive: false,
    enabled: true,
    description: 'I before E exception: recieve → receive',
  ...
  },
  {
    ...
    caseSensitive: false,
    enabled: true,
    description: 'Common word ending confusion: seperate → separate',
  ...
  },
  {
    ...
    caseSensitive: false,
    enabled: true,
    description: 'Common homophone confusion: would of → would have',
    examples: ['I would of gone there', 'She would of helped us'],
    createdAt: Date.now(),
    updatedAt: Date.now(),
    usage: { timesApplied: 0, timesRejected: 0 }
  }
